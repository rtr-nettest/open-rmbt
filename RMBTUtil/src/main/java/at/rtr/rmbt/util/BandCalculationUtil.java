...
public class BandCalculationUtil {
    ...
    private static HashMap<Integer, UMTSBand> umtsBands = new HashMap<Integer, UMTSBand>() {{
        put(1, new UMTSBand(1, 1922.4, 1977.6, 2112.4, 2167.6, 9612, 9888, -950, "2100"));
        put(2, new UMTSBand(2, 1852.4, 1907.6, 1932.4, 1987.6, 9262, 9538, -400, "1900 PCS"));
        put(3, new UMTSBand(3, 1712.4, 1782.6, 1807.4, 1877.6, 937, 1288, -225, "1800 DCS"));
        put(4, new UMTSBand(4, 1712.4, 1752.6, 2112.4, 2152.6, 1312, 1513, -225, "AWS-1"));
        put(5, new UMTSBand(5, 826.4, 846.6, 871.4, 891.6, 4132, 4233, -225, "850"));
        put(6, new UMTSBand(6, 832.4, 837.6, 877.4, 882.6, 4162, 4188, -225, "850 Japan"));
        put(7, new UMTSBand(7, 2502.4, 2567.6, 2622.4, 2687.6, 2012, 2338, -225, "2600"));
        put(8, new UMTSBand(8, 882.4, 912.6, 927.4, 957.6, 2712, 2863, -225, "900 GSM"));
        put(9, new UMTSBand(9, 1752.4, 1782.4, 1847.4, 1877.4, 8762, 8912, -475, "1800 Japan"));
        put(10, new UMTSBand(10, 1712.4, 1767.6, 2112.4, 2167.6, 2887, 3163, -225, "AWS-1+"));
        put(11, new UMTSBand(11, 1430.4, 1445.4, 1478.4, 1493.4, 3487, 3562, -225, "1500 Lower"));
        put(12, new UMTSBand(12, 701.4, 713.6, 731.4, 743.6, 3617, 3678, -225, "700 a"));
        put(13, new UMTSBand(13, 779.4, 784.6, 748.4, 753.6, 3792, 3818, -225, "700 c"));
        put(14, new UMTSBand(14, 790.4, 795.6, 760.4, 765.6, 3892, 3918, -225, "700 PS"));
        put(19, new UMTSBand(19, 832.4, 842.6, 877.4, 887.6, 312, 363, -400, "800 Japan"));
        put(20, new UMTSBand(20, 834.4, 859.6, 793.4, 818.6, 4287, 4413, -225, "800 DD"));
        put(21, new UMTSBand(21, 1450.4, 1460.4, 1498.4, 1508.4, 462, 512, -400, "1500 Upper"));
        put(22, new UMTSBand(22, 3412.4, 3487.6, 3512.4, 3587.6, 4437, 4813, -225, "3500"));
        put(25, new UMTSBand(25, 1852.4, 1912.6, 1932.4, 1992.6, 4887, 5188, -225, "1900+"));
        put(26, new UMTSBand(26, 816.4, 846.6, 861.4, 891.6, 5537, 5688, -225, "850+"));
    }};
