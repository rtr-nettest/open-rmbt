...
{
    private final String webRoot = "http://develop.netztest.at/en";
    @Get("html")
    public String request(final String entity)
    {
        ...
        try
        {
            ...
            ResultSet rs;
            String sql;
            List<Map.Entry<Long,Long>> statTests = new ArrayList<Map.Entry<Long, Long>>();
            List<Map.Entry<Long,Long>> statClients = new ArrayList<Map.Entry<Long, Long>>();
            List<Map.Entry<Long,Long>> statIPs = new ArrayList<Map.Entry<Long, Long>>();
            ...
            while (rs.next())
            {
                ...
                statTests.add(new AbstractMap.SimpleEntry<Long, Long>(day.getTime(), countTests));
                statClients.add(new AbstractMap.SimpleEntry<Long, Long>(day.getTime(), countClients));
                statIPs.add(new AbstractMap.SimpleEntry<Long, Long>(day.getTime(), countIPs));
     ...
     */
    private String makeStat(List<Map.Entry<Long,Long>> tests, List<Map.Entry<Long,Long>> clients, List<Map.Entry<Long,Long>> ips) {
        ...
        String ret = "<script type=\"text/javascript\">\n" +
                    ...
                    "            $.plot(\"#flot\", [{data: t, label: 'Visitors'},{data: c, label: 'Clients'},{data: i,label:'IPs'}], {\n" +
                    "                        xaxis: {\n" +
                    "                                mode: \"time\",\n" +
                    "                                minTickSize: [1, \"day\"],\n" +
                    "                                timeformat: \"%d.%m.\"\n" +
