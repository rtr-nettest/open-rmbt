...
public class Speed_up
{
    ...
    public Speed_up(final Connection conn)
    {
        reset();
        this.conn = conn;
    }
    
    public Speed_up(final Connection conn, final long uid, final long test_id, final Timestamp tstamp,
    ...
    public void storeSpeed_up()
    {
        ...
        try
        {
            ...
            st = conn.prepareStatement(
                    "INSERT INTO speed_up(test_id, time, sumAllTrans, sumDiffTrans, maxAllTime, maxDiffTime)"
            ...
            {
                reset();
                setError("ERROR_DB_STORE_SPEED_UP");
        ...
        {
            setError("ERROR_DB_STORE_SPEED_UP_SQL");
            // e.printStackTrace();
        }
    }
