...
public class WebsiteTestServiceImpl implements WebsiteTestService {
	...
	public void run(final String targetUrl, final long timeOut) {
		handler.post(new Runnable() {
			@Override
			public void run() {
				WebsiteTestServiceImpl.this.processUid = android.os.Process.myUid();
				...
				task.setContentRetrieverListener(new AsyncHtmlContentRetriever.ContentRetrieverListener() {
