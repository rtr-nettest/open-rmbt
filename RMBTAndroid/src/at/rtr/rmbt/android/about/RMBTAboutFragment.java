 ...
 ******************************************************************************/
package at.rtr.rmbt.android.about;
...
public class RMBTAboutFragment extends Fragment
{
    ...
    private String getAppInfo(final Context context)
    {
        ...
        try
        {
            //apk build timestamp (as set in build.gradle)
            String date = DateFormat.getDateTimeInstance().format(new Date(BuildConfig.BUILD_TIMESTAMP));
            pInfo = context.getPackageManager().getPackageInfo(context.getPackageName(), 0);

            //note: revision set in revision.properties, generated by RMBTClient build.gradle,
